...
class Auth::PasswordResetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get edit" do
    ...
    get edit_auth_password_reset_url(sid: sid)
    assert_response :success
  end

  test "should send a password reset email" do
    assert_enqueued_email_with UserMailer, :password_reset, params: { user: @user } do
      post auth_password_reset_url, params: { email: @user.email }
    end
  ...
  test "should not send a password reset email to a nonexistent email" do
    assert_no_enqueued_emails do
      post auth_password_reset_url, params: { email: "invalid_email@hey.com" }
    end

    assert_redirected_to new_auth_password_reset_url
  ...
  test "should update password" do
    ...
    patch auth_password_reset_url, params: { sid: sid, password: "Secret6*4*2*", password_confirmation: "Secret6*4*2*" }
    assert_redirected_to sign_in_url
  end
